...
const Footer = () => {
  return (
<footer className="footer footer-center p-10 text-primary-content" style={{ borderRadius: "39px", background:"#00c3ff"}}>
  <aside>
    ...
    <p className="font-bold">
      LivDer Industries Ltd. <br/>Providing reliable tech since 2023
    </p> 
