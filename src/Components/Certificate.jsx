		...
		<div className="hero min-h-screen bg-white">
			<div className="hero-content flex-col lg:flex-row-reverse">
				...
				<div>
					...
					>
						At SalesforceHub, we are proud to be recognized as a
						top-performing Salesforce consulting partner. This
						prestigious designation, awarded to only the top 10% of
						partners globally, reflects our unwavering commitment to
