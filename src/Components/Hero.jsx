							...
							<div className="md:col-span-5 flex items-center justify-center p-8 xl:p-16">
								<div className="flex flex-col gap-8">
									<h1 className="text-5xl xl:text-7xl font-bold xl:leading-[7.5rem]">
										Join the #1 pathway for high-growth tech
										careers!{" "}
									...
									<p className="text-gray-500 text-2xl leading-[2.5rem]">
										Find your purpose Explore our career
										paths We invest in our students by
										constantly monitoring the job market and
									</p>
									<p className="text-gray-500 text-2xl leading-[2.5rem]">
										cutting-edge technologies and revising
										our curriculum to reflect the most
										in-demand skills.
									</p>
